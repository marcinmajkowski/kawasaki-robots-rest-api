...
include::{snippets}/drive-instruction/response-fields.adoc[]

==== Example request

include::{snippets}/drive-instruction/curl-request.adoc[]

include::{snippets}/drive-instruction/http-request.adoc[]

==== Example response

include::{snippets}/drive-instruction/http-response.adoc[]
