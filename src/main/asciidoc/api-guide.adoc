...
include::{snippets}/resources-robot-instruction/response-fields.adoc[]

==== Example request

include::{snippets}/resources-robot-instruction/curl-request.adoc[]

include::{snippets}/resources-robot-instruction/http-request.adoc[]

==== Example response

include::{snippets}/resources-robot-instruction/http-response.adoc[]
...
KawasAPI tries to adhere as closely as possible to standard HTTP and REST conventions in its
use of HTTP verbs.
...
include::{snippets}/reals/http-response.adoc[]
